...
<head>
    ...
    <link rel="stylesheet" href="cccc.css">
</head>
<body>
    <nav>
        <div class="profil">
    ...
    <div class="f">
        <div class="gg">
            <ul class="rr">
                <li class="active"><a href="#"><i class="fas fa-plus" style="font-size:30px"></i> Publier</a></li>
                <li><a href="ami.html"><i class="fa-solid fa-user-group" style="font-size:29px"> </i> Amis</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Paramètres </a></li>
                <li><a href="connecter.html"><i class="fa-solid fa-right-from-bracket" style="font-size:30px"></i> Déconnecter</a></li>
            </ul>
        </div>
        <div class="ff">
           
           <p><h2>Publier statue</h2></p> 
        </div>
